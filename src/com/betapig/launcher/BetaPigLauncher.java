...
public class BetaPigLauncher extends JFrame {
    ...
    public BetaPigLauncher() {
        ...
        StringBuilder newsBuilder = new StringBuilder()
                ...
                .append("<h2 style='color: " + getHexColor(ACCENT_COLOR) + "; text-align: center;'>BETAPIG LAUNCHER</h2>")
                .append("<hr>")
                .append("<p><b>🎮 Привет игрок!</b> </p>")
                .append("<p><b>🌟 Добро пожайловать на сервер BetaPig!</b></p>")
                .append("<ul>")
                .append("<li>На версии " + GameManager.SERVER_VERSION + "</li>")
                .append("<li>У нас: Дружелюбное сообщество</li>")
                .append("<li>Запуск серврера в 18:00 15.05.2025</li>")
                .append("</ul>")
                .append("<p><b>📢 Последние новости:</b></p>")
                .append("<ul>")
                .append("<li>Релиз лаунчера</li>")
                .append("<li>Улучшена стабильность сервера</li>")
                .append("<li>Поствлен оптифайн</li>")
                .append("</ul>")
